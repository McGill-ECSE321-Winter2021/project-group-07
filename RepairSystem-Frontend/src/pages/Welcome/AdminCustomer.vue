            ...
            <div class="row" style="position: relative; top: 20px">
                ...
                <b-modal id="modal-prevent-closing" ref="modal" title="Add New Customer" @show="resetModal" @hidden="resetModal" @ok="createCustomer(name,password,phone,email,credit,debit, address)">
                    <b-form ref="form" @submit.stop.prevent="handleSubmit">
                        ...
                        <b-form-group label="Credit Card" label-for="CreditCard">
                            <b-form-input id="credit-input" v-model="credit" :state="creditState"></b-form-input>
                        </b-form-group>

                        <b-form-group label="Debit Card" label-for="DebitCard">
                            <b-form-input id="debit-input" v-model="debit" :state="debitState"></b-form-input>
                        </b-form-group>
                    </b-form>
                    ...
                    <b-modal v-model="modalShow" title="Edit Profile" id="modal-scoped">
                        <b-form ref="form" @submit.stop.prevent="handleSubmit">
                            ...
                            <b-form-group label="Email" label-for="editEmail-input" invalid-feedback="Email is required" :state="editEmailState">
                                <b-form-input id="editEmail" type="text" v-model="editEmail" name="editEmail" :value="editEmail">
                                </b-form-input>
                            </b-form-group>
                            ...
                            <b-form-group label="Residence " :state="editResidenceState">
                                <b-form-input id="editPassword" v-model="editResidence" type="text" name="editPassword" :value="editResidence">
                                </b-form-input>
                            </b-form-group>

                            <b-form-group label="Credit Card" label-for="editCredit-input" invalid-feedback="Credit is required" :state="editCreditState">
                                <b-form-input id="editCredit" v-model="editCredit" type="text" name="editCredit" :value="editCredit">
                                </b-form-input>
                            </b-form-group>

                            <b-form-group label="Debit Card" label-for="editDebit-input" invalid-feedback="Debit is required" :state="editDebitState">
                                <b-form-input id="editDebit" v-model="editDebit" type="text" name="editDebit" :value="editDebit">
                                </b-form-input>
                            </b-form-group>
