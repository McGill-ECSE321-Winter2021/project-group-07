...
public class MechanicService {
	...
	public Mechanic createMechanic(String aName, String aPassword, int aPhone, String aEmail, RepairSystem aRepairSystem, List<ca.mcgill.ecse321.repairsystem.model.Service> allCapabilities) {
		if (aName == null || aName.trim().length() == 0) throw new IllegalArgumentException("Mechanic name cannot be empty!");
		if (aPassword == null || aPassword.trim().length() == 0) throw new IllegalArgumentException("Mechanic passward cannot be empty!");
		if (aEmail == null || aEmail.trim().length() == 0) throw new IllegalArgumentException("Mechanic email cannot be empty!");
		if (aRepairSystem == null) throw new IllegalArgumentException("Mechanic repair system cannot be empty!");
		if (allCapabilities == null) throw new IllegalArgumentException("Mechanic service cannot be empty!");
